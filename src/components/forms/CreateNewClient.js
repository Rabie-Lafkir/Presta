...
const CreateNewClient = () => {
  ...
  return (
    <form className="w-full" action={createNewClient}>
      ...
      <div className="w-full flex flex-col items-center justify-center my-5">
        <button
          className="flex items-center bg-emerald-500 rounded shadow px-8 py-4 text-white font-semibold hover:bg-emerald-600 hover:shadow-lg cursor-pointer"
          disabled={passError || phone?.length != 10 }
        >
          Créer l'utilisateur
        </button>
      </div>
